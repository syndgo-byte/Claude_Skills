...
- [free-ai-offers](free-ai-offers/) — VS Code 확장. 무료 AI/LLM 혜택과 마감일을 추적(OpenRouter, Vercel AI Gateway, 공식 변경 기록, 뉴스, YouTube). `claude-plugin-manager`에서 분리된 독립 확장. Claude 토큰을 쓰지 않음.
